...
Version: 1.0
Author: Michael W. Delaney & Jon Mather
Author URI:
License: MIT
*/
...
add_action( 'plugins_loaded', function() {
	...
	/**** EDITED BY JON TO LOAD CUSTOM functions */
	require_once(ACFFCB_PLUGIN_DIR . 'lib/hex2rgb.php');
	require_once(ACFFCB_PLUGIN_DIR . 'lib/jons-custom-functions.php');
	/**** END JONS CHANGES ****/
