...
class Fields {
	 ...
	 * Parallax
	 */
	function parallax_effect($thisKey = 'field') {
		return(
			array (
				'key' => $this->key . '-' . $thisKey . '-' . __FUNCTION__,
			    'label' => 'Add Parallax?',
	 ...
	 * Overlay
	 */
	function background_overlay($thisKey = 'field') {
		return(
			array (
				'key' => $this->key . '-' . $thisKey . '-' . __FUNCTION__,
			    'label' => 'Use Background Colour as Overlay?',
	 ...
	 * Overlay Opacity
	 */
	function overlay_opacity($thisKey = 'field') {
		return(
			array (
			    'key' => $this->key . '-' . $thisKey . '-' . __FUNCTION__,
