    ...
    class CreateBlocks {
         ...
         */
          ...
          function __construct() {
            ...
            /**** EDITED BY JON TO LOAD THE FRONTEND SCRIPTS AND SASS */						
            ...
            $this->args = array (
                ...
                /**** EDITED BY JON TO HIDE DEFAULT CONTENT */
        ...
        /**** EDITED BY JON TO LOAD THE FRONTEND SCRIPTS AND SASS */
            function frontend_scripts() {
                ...
                wp_enqueue_script( 'acf-flexible-content-frontend', ACFFCB_PLUGIN_URL . 'assets/js/project.js', array(), '1.0.0', true );
            }

            function frontend_styles() {
                wp_enqueue_style( 'acf-flexible-content-frontend', ACFFCB_PLUGIN_URL . 'assets/css/project.css' );
            }
        /**** END JONS CHANGES ****/
